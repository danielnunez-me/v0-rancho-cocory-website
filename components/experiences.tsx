    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          ...
          <AddItemButton label="Añadir Nueva Experiencia" />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {amenities.map((item) => (
            <div
              key={item.title}
              className="group relative flex flex-col items-center text-center p-8 rounded-2xl bg-background border border-border/50 hover:border-primary/30 hover:shadow-lg transition-all duration-300"
            >
              <ItemControls itemLabel={item.title} />
