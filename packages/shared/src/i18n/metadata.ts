...
const metadataByLocale: Record<Locale, LocaleMetadata> = {
  ...
  en: {
    ...
    description:
      "Rancho Cocory is the family recreational park in Higuey with pools, buggy tours, horseback riding, paintball, and more. From RD$350 per adult.",
    keywords: [
      "Rancho Cocory",
      "recreational park",
      "Higuey",
    ...
    openGraph: {
      title: "Rancho Cocory | Recreational Park in Higuey",
      description:
