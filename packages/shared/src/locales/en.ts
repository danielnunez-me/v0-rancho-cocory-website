    ...
    items: [
      {
        ...
        priceDetail:
          "per adult Monday-Friday. RD$450 on Saturdays, Sundays, and holidays.",
        description:
      ...
      },
      {
        ...
        description:
          "Explore the tropical landscapes of Higuey on an exciting off-road buggy adventure.",
        includes: [
          "Off-road buggy",
          "Tour guide",
          "Safety equipment",
  ...
  experiences: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "On-site venues with traditional Dominican food and drinks.",
      },
    ],
  },
  gallery: {
    ...
    items: [
      {
        ...
        answer:
          "General admission includes full access to adult and children's pools, the lake, natural areas, playground, sports courts, picnic areas, and all common areas of the park.",
      },
      {
        id: "faq-2",
        question: "Do excursions include food?",
        answer:
          "Buggy and horseback excursions do not include food, but you can purchase food and drinks at our on-site venues. The day pass also does not include food, but we have delicious traditional Dominican food options inside the park.",
      },
      {
        id: "faq-3",
      ...
      },
      {
        ...
        answer:
          "Outside food is not allowed in the park. However, we offer a variety of affordable on-site dining options with traditional Dominican food.",
      },
    ],
  },
  contact: {
